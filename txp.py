...
# -- coding: utf-8 --
# -------------------------------
# ✨✨✨ @Author ArcadiaScriptPublic 20240711 ✨✨✨
# -------------------------------
# cron: 51 9 * * *
# export txp=  多账号用 换行 或 @ 分割
# new Env('天禧派')
import os
import random
import time
...
''')
    ...
    if IS_DEV:
        ...
        if os.path.isfile('CHERWIN_TOOLS.py'):
            ...
            if down_file('CHERWIN_TOOLS.py', 'https://github.com/zjk2017/CHERWIN_SCRIPTS/raw/main/CHERWIN_TOOLS.py'):
